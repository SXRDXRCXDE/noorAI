                    ...
                    <div className={'w-full h-full relative'}>
                        ...
                        <div className={`absolute right-[248px] top-[207px] w-[488px] h-[530px] `}>
                            <div className={`w-full h-full relative`}>
                                ...
                                <div className={` form_background2 absolute right-[24px] top-0 bottom-0 m-auto rounded-r-3xl w-[24px] h-[456px] `}></div>
                                <div className="form_back3 border border-white absolute right-[48px] top-0 bottom-0 m-auto rounded-3xl w-[440px] h-[530px] py-0.5 px-0.5">
                                    <div className={`form_background3_content`}>
                                        ...
                                        <div className={'font-sfPro  w-full flex flex-col items-center gap-[26px] '}>
                                            <span className={'text-[#757185] text-[16px] font-[590]'}>Or sign in with open accounts</span>
