            ...
            <div className={`absolute left-0 top-0 w-full h-full flex items-start pt-[104px] px-[109px] `}>
                ...
                <div className={`w-1/2 max-w-[608px] h-full flex flex-col items-start pt-[90px] `}>
                    <div className={`w-full flex flex-col items-start`}>
                        ...
                        <span data-aos={`fade-left`} className={`text-white font-sfPro font-bold text-5xl leading-none tracking-normal align-middle`}>Un robot éducatif, pensé pour l’humain.</span>
                        <span data-aos={`fade-left`} data-aos-delay={`500`} className={`mt-8 text-white font-sfPro font-normal text-2xl leading-none tracking-normal align-middle`}>
...
export function Section2() {
    ...
    return(
        <div className={`w-full h-[1044px] relative overflow-hidden`}>
            ...
            <GradientBlob width={635} height={542} className={`absolute right-[22px] bottom-[124px] `} />
            ...
            <div className={`absolute top-0 left-0 w-full h-full pt-[96px] flex flex-col items-center  `}>
                <div className={`max-w-[950px] flex flex-col items-center`}>
                        <span data-aos={`fade-down`} className={`text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.48)] font-sfPro font-bold text-5xl leading-none tracking-normal text-center align-middle`}>
                            Caractéristiques techniques
                        </span>
                    <span data-aos={`fade-down`} data-aos-delay={`500`} className={`text-white/70 font-sfPro font-normal text-2xl leading-[150%] tracking-normal text-center align-middle`}>Conçu à Paris avec une technologie intelligente et centrée sur l'humain pour améliorer l'apprentissage, la communication et la connexion émotionnelle - le tout dans un seul et même compagnon intelligent.</span>
                </div>
        ...
        <div className={`w-full h-[976px] relative overflow-hidden bg-[#FFFFFF1A]`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full pt-[114px] flex flex-col items-center`}>
                ...
                <div className={`flex flex-col items-center`}>
                    <span data-aos={`fade-down`} className={`text-white font-sfPro font-bold text-5xl leading-none tracking-normal text-center align-middle`}>Fonctionnalités clés</span>
                    <span data-aos={`fade-down`} data-aos-delay={`500`} className={`mt-4 text-white/70 font-sfPro font-normal text-2xl leading-[150%] tracking-normal text-center align-middle`}>NoorAI, c’est plus qu’un outil : c’est un partenaire de confiance pour la réussite de votre enfant.</span>
                </div>

                <div className={`w-full flex flex-col items-center mt-[72px] px-[120px]`}>
                    <div className={`flex items-start gap-[29px] `}>
                        {Cards.map((value, index)=>  <div data-aos={`fade-down`} data-aos-delay={`${index*400}`} key={index} className={`w-[278px] flex flex-col items-center`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full flex items-start pt-[104px] px-[109px] `}>
                ...
                <div className={`w-1/2 max-w-[608px] h-full flex flex-col items-start pt-[90px] `}>
                    <div className={`w-full flex flex-col items-start`}>
                            ...
                            <span data-aos={`fade-left`} className={`text-white font-sfPro font-bold text-5xl leading-none tracking-normal align-middle`}>
    ...
    return(
        <div className={`w-full h-[989px] overflow-hidden relative`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full pt-[114px] flex flex-col items-center`}>
                ...
                <div className={`flex flex-col items-center`}>
                    <span data-aos={`fade-down`} className={`text-white font-sfPro font-bold text-5xl leading-none tracking-normal text-center align-middle`}>Les avantages de NoorAI</span>
                    <span data-aos={`fade-down`} data-aos-delay={`500`} className={`max-w-[720px] mt-4 text-white/70 font-sfPro font-normal text-[24px] leading-[150%] tracking-normal text-center align-middle`}>Offrez à votre enfant un environnement où il se sent compris, encouragé et valorisé.</span>
                </div>
