...
export function Section1() {
    return(
        <div className={`w-full h-[775px] relative bg-[#08063EA6] overflow-hidden`}>
            ...
            <BlobBackground width={520} height={554} className="absolute max-[750px]:left-0 max-[750px]:right-0 max-[750px]:top-28 max-[750px]:m-auto max-[750px]:w-[220px] max-[750px]:h-[254px] max-[980px]:w-[420px] max-[980px]:h-[454px] max-[980px]:left-[9px] max-[1200px]:left-[59px] top-[144px] left-[109px]" />
            <BlobBackground width={470} height={502} className="absolute max-[750px]:left-0 max-[750px]:right-0 max-[750px]:top-[138px] max-[750px]:m-auto max-[750px]:w-[170px] max-[750px]:h-[202px] max-[980px]:w-[370px] max-[980px]:h-[402px] max-[980px]:left-[34px] max-[1200px]:left-[84px] top-[170px]  left-[134px]" />
            <Image
                data-aos={`zoom-in`}
                data-aos-delay={`500`}
                src={robot}
                alt="bg"
                className="absolute max-[750px]:left-0 max-[750px]:right-0 max-[750px]:top-44 max-[750px]:m-auto max-[750px]:w-[152px] max-[750px]:h-[152px] max-[980px]:w-[302px] max-[980px]:h-[302px] max-[980px]:left-[68px] max-[1200px]:left-[118px] left-[168px] top-[211px] object-cover w-[402px] h-[402px] object-cover "
            />
            <div className={`absolute left-0 top-0 w-full h-full flex items-start pt-[104px] max-[980px]:px-[20px] px-[109px] `}>
                <div className={`w-1/2 max-[750px]:hidden h-full`}></div>
                <div className={`w-1/2 max-[750px]:w-full max-[750px]:pt-[220px] max-w-[608px] h-full flex flex-col items-start pt-[90px] `}>
                    <div className={`w-full flex flex-col items-start`}>
                        ...
                        <span data-aos={`fade-left`} data-aos-delay={`500`} className={`mt-8 max-[750px]:mt-3 text-white font-sfPro font-normal max-[980px]:text-xl text-2xl leading-none tracking-normal align-middle`}>
                        ...
                        <div data-aos={`fade-left`} data-aos-delay={`1000`}>
                            <GradientButton  className={`rounded-full text-white max-[750px]:mt-[30px] mt-[70px] font-sfPro font-medium max-[980px]:text-xl text-2xl leading-none tracking-normal align-middle max-[980px]:w-[258px] max-[980px]:h-[55px] w-[358px] h-[69px]`}>Découvrez NoorAI</GradientButton>
                        </div>
...
export function Section2() {
    ...
    return(
        <div className={`w-full h-[1044px] max-[360px]:h-[1544px] max-[750px]:h-[1444px] relative overflow-hidden`}>
            ...
            <GradientBlob width={635} height={542} className={`absolute max-[750px]:-translate-x-5 max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[750px]:bottom-[20px] max-[980px]:w-[435px] max-[980px]:h-[342px] max-[980px]:right-0 right-[22px] bottom-[124px] `} />
            <GradientBlob width={587} height={501} className={`absolute max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[750px]:bottom-[40px] max-[980px]:w-[387px] max-[980px]:h-[301px] max-[980px]:right-[24px] right-[46px] bottom-[144px] `} />
            <Image
                data-aos={`zoom-in`}
                data-aos-delay={500}
                src={phone}
                alt="bg"
                className="absolute max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[750px]:w-[325px] max-[750px]:h-[361px] max-[750px]:bottom-[89px] max-[980px]:w-[455px] max-[980px]:h-[491px] max-[980px]:right-[0px] right-[92px] scale-x-[-1] bottom-[189px] w-[555px] h-[591px] object-contain  "
            />
            <div className={`absolute top-0 left-0 w-full h-full max-[980px]:pt-[46px] pt-[96px] flex flex-col items-center  `}>
                <div className={`max-w-[950px] max-[750px]:px-2 flex flex-col items-center`}>
                ...
                <div className={`w-full flex items-start mt-[74px] max-[980px]:pl-[20px] pl-[131px]`}>
                    <div className={`w-1/2 max-[750px]:w-full flex flex-col items-start gap-[32px]`}>
                        {Options.map((value, index)=> <div data-aos={`fade-down`} data-aos-delay={`${index*300}`} key={index} className={`flex items-center `}>
                            ...
                            />
                            <div className={`flex flex-col items-start max-[750px]:ml-2 ml-10 gap-3`}>
...
export function Section3() {
    ...
    return(
        <div className={`w-full h-[976px] max-[462px]:h-[1600px] relative overflow-hidden bg-[#FFFFFF1A]`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full max-[980px]:pt-[30px] max-[1200px]:pt-[64px] pt-[114px] flex flex-col items-center`}>
                ...
                <div className={`w-full flex flex-col items-center max-[1200px]:mt-[20px] mt-[72px] max-[700px]:px-[15px] px-[120px]`}>
...
export function Section4() {
    return(
        <div className={`w-full h-[786px] max-[330px]:h-[850px] relative overflow-hidden `}>
            <Image
                src={bg_new}
                alt="bg"
                className="absolute left-0 top-0 object-cover w-full h-full "
            ...
            <BlurredBlob width={531} height={534} className="absolute max-[750px]:-translate-y-[400px] max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[750px]:w-[231px] max-[750px]:h-[234px] max-[980px]:w-[431px] max-[980px]:h-[434px] max-[1200px]:left-[24px] bottom-[108px] left-[84px] backdrop_blur-[123px]" />
            <BlurredBlob width={444} height={448} className="absolute max-[750px]:-translate-y-[400px] max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[750px]:w-[144px] max-[750px]:h-[148px] max-[980px]:w-[344px] max-[980px]:h-[348px] max-[1200px]:left-[68px] bottom-[153px] left-[128px] backdrop_blur-[123px]" />
            <Image
                data-aos={`zoom-in`}
                data-aos-delay={`500`}
                src={online}
                alt="bg"
                className="absolute max-[330px]:top-32 max-[750px]:top-16 max-[750px]:left-0 max-[750px]:right-0 max-[750px]:m-auto max-[980px]:top-[281px] max-[1200px]:left-[68px] left-[168px] top-[211px] object-cover max-[750px]:w-[152px] max-[750px]:h-[152px] max-[980px]:w-[302px] max-[980px]:h-[302px] w-[402px] h-[402px] object-cover "
            />
            <div className={`absolute left-0 top-0 w-full h-full flex items-start pt-[104px] max-[980px]:px-[20px] px-[109px] `}>
                <div className={`w-1/2 max-[750px]:hidden h-full`}></div>
                <div className={`w-1/2 max-[750px]:w-full  max-w-[608px]  h-full flex flex-col items-start max-[750px]:pt-[180px] max-[1200px]:pt-[20px] pt-[90px] `}>
                    <div className={`w-full flex flex-col items-start`}>

                            <span data-aos={`fade-left`} className={`text-white font-sfPro font-bold max-[750px]:text-2xl max-[1200px]:text-3xl text-5xl leading-none tracking-normal align-middle`}>
                                Un design épuré, moderne,pensé pour s’intégrer harmonieusement partout.
                            </span>
                            <span data-aos={`fade-left`} data-aos-delay={`500`} className={`mt-8 max-[750px]:mt-4 text-white font-sfPro font-normal max-[1200px]:text-xl text-2xl leading-none tracking-normal align-middle`}>
                        ...
                        <div data-aos={`fade-left`} data-aos-delay={`1200`}>
                            <GradientBorderButton
                                text={`En savoir plus`}
                                className={`gradient_border_button centered relative text-white max-[750px]:w-[280px]  w-[358px] h-[69px] mt-[37px]`}
...
export function Section5() {
    ...
    return(
        <div className={`w-full h-[989px] max-[450px]:h-[1050px] overflow-hidden relative`}>
            ...
            <WhiteGradientBlob width={488} height={460} className="absolute max-[670px]:right-0 max-[670px]:left-0 max-[670px]:m-auto max-[670px]:top-[615px] max-[980px]:w-[388px] max-[980px]:h-[360px] max-[980px]:right-[18px] max-[1200px]:right-[48px] top-[265px] right-[148px] backdrop_blur-[123px]" />
            <WhiteGradientBlob width={437} height={412} className="absolute max-[670px]:right-0 max-[670px]:left-0 max-[670px]:m-auto max-[670px]:top-[639px] max-[980px]:w-[337px] max-[980px]:h-[312px] max-[980px]:right-[34px] max-[1200px]:right-[74px] top-[289px] right-[174px] backdrop_blur-[123px]" />
            <Image
                data-aos={`zoom-in`}
                data-aos-delay={`500`}
                src={cartoon}
                alt="bg"
                className="absolute max-[670px]:right-0 max-[670px]:left-0 max-[670px]:m-auto max-[670px]:top-[566px] max-[980px]:w-[376px] max-[980px]:h-[419px] max-[980px]:right-[30px] max-[1200px]:right-[80px] right-[180px] top-[216px] object-cover w-[476px] h-[519px] object-cover "
            />
            <div className={`absolute left-0 top-0 w-full h-full pt-[114px] flex flex-col items-center`}>

                <div className={`flex flex-col items-center`}>
                    <span data-aos={`fade-down`} className={`text-white font-sfPro font-bold max-[670px]:text-3xl text-5xl leading-none tracking-normal text-center align-middle`}>Les avantages de NoorAI</span>
                    <span data-aos={`fade-down`} data-aos-delay={`500`} className={`max-w-[720px] mt-4 text-white/70 font-sfPro font-normal max-[670px]:text-[18px] text-[24px] leading-[150%] tracking-normal text-center align-middle`}>Offrez à votre enfant un environnement où il se sent compris, encouragé et valorisé.</span>
                </div>

                <div className={`w-full flex items-start max-[670px]:mt-[24px] mt-[74px] max-[670px]:pl-3 max-[1200px]:pl-[41px] pl-[131px]`}>
                    <div className={`w-1/2 max-[670px]:w-full flex flex-col items-start max-[670px]:gap-[16px] gap-[32px]`}>
                ...
                <div data-aos={`fade-down`} data-aos-delay={`1000`}>
                    <GradientButton className={` max-[670px]:w-[258px] w-[358px] max-[670px]:h-[55px] h-[69px] max-[670px]:mt-[55px] mt-[175px] text-white rounded-full font-sfPro font-medium max-[420px]:text-xl text-2xl leading-none tracking-normal align-middle`}>Voir NoorAI en action</GradientButton>
                </div>
            </div>
        </div>
    );
