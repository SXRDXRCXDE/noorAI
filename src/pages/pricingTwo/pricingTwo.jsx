...
export function Section2() {
    const [active, setActive] = useState("Renting");
    return(
        <div className={`w-full h-[1254px] bg-[#FFFFFF14] relative overflow-hidden`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full flex flex-col items-center  pt-[56px]`}>
                ...
                <div className={'w-full px-[120px] flex flex-col items-center mt-[59px] gap-[51px] '}>
                    <div className={`w-full max-w-[1200px] h-[752px] pricing_card2`}>
                        <div className={`w-full h-full rounded-[29px]  flex items-start justify-center bg-[#FFFFFF0A]`}>

                            <Image
                                src={phone}
                                alt="bg"
                                className="self-center object-contain scale-x-[-1] w-[446px] h-[584px]  "
                            />

                            <div className={`self-center w-[1px] h-[584px] bg-gradient-to-b from-transparent via-[#E7E7E7] to-transparent`}></div>

                            <div className={`w-[455px] mt-[65px] ml-[80px] flex flex-col items-start `}>
                                ...
                                <div className={`w-full flex flex-col items-start`}>
                                    ...
                                    <span className={`text-white font-sfPro font-semibold text-[32px] leading-[24px] tracking-[-0.012em]`}>Achat unique</span>

                                    <div className={`w-full h-[1px] mt-[31px] bg-gradient-to-r from-transparent via-[#E7E7E7] to-transparent `}></div>

                                    <div className={`w-full flex items-center mt-[31px] justify-between`}>
                                        <span className={`text-white font-sfPro font-normal text-[24px] leading-[24px] tracking-[-0.012em]`}>Paiement unique : </span>
                                        <span className={` text-[#F6EB13]  font-sfPro font-normal text-[24px] leading-[24px] tracking-[-0.012em]`}>189 € TTC</span>
                                    </div>

                                    <div className={`w-full flex flex-col items-start mt-[65px]`}>
                                    <span className={`text-white font-sfPro font-semibold text-[18px] leading-[24px] tracking-[-0.012em]`}>
                                        ...
                                        <div className={`w-full flex flex-col items-start mt-[17px] gap-y-3 `}>
                                            ...
                                            <GradientButton className={`w-[250px] h-[44px] rounded-full mt-[94px]`}>Choose Plan</GradientButton>
