        ...
        <div className={`w-full max-[588px]:h-[calc(804px+467px+100px+600px)] max-[980px]:h-[calc(804px+467px+100px)] h-[calc(804px+467px)] relative `}>
            ...
            <div className={`absolute top-0 left-0 w-full h-full max-[1200px]:pt-[160px] pt-[236px] flex flex-col items-center `}>
                ...
                <div className={`flex flex-col items-center`}>
                    ...
                    <span data-aos={`fade-down`} data-aos-delay={`500`} className={`text-[#FFFFFF] max-w-[950px] mt-[28px] font-sfPro font-bold max-[1200px]:text-3xl text-5xl leading-none tracking-normal text-center align-middle  `}>Choisissez le plan qui vous convient</span>
                    <span data-aos={`fade-down`} data-aos-delay={`1000`} className={`text-[#FFFFFF]/70 max-w-[950px] mt-[24px] font-sfPro font-normal max-[1200px]:text-lg text-2xl leading-8 tracking-normal text-center align-middle  `}>Whether you're a parent, educator, or school, we offer flexible pricing plans tailored to your needs — so you can get the most out of NoorAI at your own pace.</span>
                </div>
                ...
                <div className={`flex max-[980px]:flex-wrap max-[980px]:justify-center items-start gap-[30px] max-[980px]:mt-[20px] max-[1200px]:mt-[150px] mt-[69px]`}>
                    ...
                    {Services.map((value, index)=> <div data-aos={`fade-down`} data-aos-delay={`${index*500}`} key={index} className={`max-[1200px]:w-[279px] max-[980px]:h-[467px] max-[1200px]:h-[567px] w-[379px] h-[667px] pricing_card`}>
    ...
    return(
        <div className={`w-full h-[1254px] bg-[#FFFFFF14] relative overflow-hidden`}>
            ...
            <div className={`absolute left-0 top-0 w-full h-full flex flex-col items-center  pt-[56px]`}>
                ...
                <div className={'w-full max-[738px]:px-[15px] max-[1200px]:px-[60px] px-[120px] flex flex-col items-center mt-[59px] gap-[51px] '}>
                    <div data-aos={`fade-down`} data-aos-delay={`500`} className={`w-full max-w-[1200px] h-[752px] pricing_card2`}>
                        <div className={`w-full h-full rounded-[29px] flex max-[738px]:flex-col items-start justify-center bg-[#FFFFFF0A]`}>

                            <Image
                                src={phone}
                                alt="bg"
                                className="self-center object-contain scale-x-[-1] max-[738px]:w-[126px] max-[738px]:h-[204px] max-[1200px]:w-[346px] max-[1200px]:h-[484px] w-[446px] h-[584px]  "
                            />

                            <div className={`self-center w-[1px] h-[80%] max-[738px]:hidden bg-gradient-to-b from-transparent via-[#E7E7E7] to-transparent`}></div>

                            <div className={`max-w-[455px] max-[738px]:max-w-full w-full mt-[65px] max-[738px]:mt-[0px] max-[980px]:ml-[0px] max-[980px]:px-[15px] max-[1200px]:ml-[30px] ml-[80px] flex flex-col max-[738px]:items-center items-start `}>
                                ...
                                <div className={`w-full flex flex-col max-[738px]:items-center items-start`}>
                                    ...
                                    <div className={`w-full flex flex-col items-start max-[738px]:mt-[20px] mt-[65px]`}>
                                    <span className={`text-white font-sfPro font-semibold text-[18px] leading-[24px] tracking-[-0.012em]`}>
                                        ...
                                        <div className={`w-full flex flex-col items-start mt-[17px] gap-y-3 `}>
                                            ...
                                            <GradientButton className={`w-[250px] h-[44px] rounded-full max-[738px]:self-center max-[738px]:mt-[30px] mt-[94px]`}>Choose Plan</GradientButton>
    ...
    return(
        <div className={`w-full h-[898px] max-[662px]:h-[2000px] max-[980px]:h-[1450px] relative overflow-hidden`}>
            <div className={`w-full h-full flex flex-col items-center pt-[83px] max-[420px]:px-[10px] max-[1200px]:px-[40px] px-[120px]`}>
                ...
                <div data-aos={`fade-right`} data-aos-delay={`1000`} className={`flex items-center max-[980px]:flex-wrap justify-center gap-[22px] mt-[64px]`}>
